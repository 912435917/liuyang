...
public class SendHttpclient {
    ...
    private static void buildHeaders(Map<String, String> headers, HttpUriRequest http,boolean isValidate) {
        ...
        if(isValidate){
            http.addHeader("appKey","3271558b-9713-4b99-846e-e5ee7b81c556");
            ...
            http.addHeader("sign",CheckSumBuilder.getCheckSum("603e3e47-7417-4e1e-9cae-33a83e82a81c",nonce,time+""));
        }
    }
